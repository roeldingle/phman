jQuery(document).ready(function(){
   ...
   var tb_sorter_options1 = {
      tb_selector_id : 'office-equipments-list-table',
      headers: {
         0: { sorter: false }
      }
   };
   ...
   $(".search-btn").click(function(){
      ...
      return function() {
         ...
         window.location.href = "?search=" + search.val() + search_string + $(this).attr('alt');
      }
   }());
   ...
   $("#delete-confirm-btn").click(function(){
      ...
      return function() {
         ...
         if( rows.filter(":checked").length > 0 ) {
            ...
            inreport.exec_delete(aidx, "stock|ajax_in_report|remove_office_equipments");
            aidx = [];
         }
      };
   }());
