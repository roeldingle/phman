...
<h2 class="title np fl mb10"><strong class="">Position List</strong></h2>
<div class="content np">
	...
	<span class="fl mb10 np"><a href="#" id="addNew" name="" class="btn_small btn_type_1s"><span>Add New Position</span></a></span>
...
<?php 
      ...
      if($listcount>=1){
         foreach($lists as $list){
            echo '<tr>';
            echo '<td><input class="chkboxlist'.$listcount.'" type="checkbox" value="'.$list->tp_idx .'"/></td>';
            echo '<td>'.$listcount.'</td>';
            echo '<td><a href="#" class="update_dept" name="'.$list->tp_idx .'">'.$list->tp_position .'</a></td>';
            echo '<td class="last">'.$list->tp_date_created .'</td>';
            echo '</tr>';
