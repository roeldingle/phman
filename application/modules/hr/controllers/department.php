...
class Department extends MX_Controller
{
   ...
   public function __construct()
   {
      ...
      $this->app->use_js(array("source"=>$this->module_name . "/department/department_list","cache"=>false));
   }
   
   public function index()
   {
         $adata = array();
         $adata['title'] = "Hr Management | Department";
         ...
         $oresult = $this->department_model->getList($keyword,$RowPerPage,$Curpage);
         $adata['lists'] = $oresult->result();
         

         $itotal_row =  $this->department_model->getTotal_rows($keyword);
         ...
         $this->app->content($this->module_name . '/department/index',$adata);
         $this->template->footer();
         $this->logs->set_log("Department List","READ");         
   }
