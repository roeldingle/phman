...
<div class="content np">
    <div class="table_wrap_3 mt10">
        <h2 class="title nm np fl"><strong class="">Budget Comparing - Detailed View</strong>
    ...
    <div class="table_wrap_3">
        <div class="table_fr_50 ar">
            <a href="javascript:void(0);" class="link_1" id="go_sheet_view">&gt;&gt;Switch to Spread Sheet View</a>	
        </div>						
    </div>
    <!-- table_wrap_3 -->	
                ...
                <thead class="tbground_1 ac tfonts_5">
                    <tr>
                        ...
                        <?php if($usergrade == "000001" || $usergrade == "000002") { ?>
                            <span class="edit"><a href="javascript:void(0);" name="edit_link"><?php if($vmonths->comment!=""){echo "Edit";} else { echo "Add";}?></a></span>
                        <?php } ?>
                        </th>
                        <?php } ?>
                    </tr>
...
<!-- ADD_NEW_EXPENSE_POPUP-->
<div class="popup_wrap" style="display:none;" id="update_form">
    <div class="popup">
        <a href="javascript:void(0);" class="btn_close fr cancel_form"><span>X</span></a>
        <h2><strong class="title fn mt10" id="title_form">Edit Budget Comparing Comments</strong></h2>
        <form action="">
            <div id="comment_err" style="max-width:90%;"></div>
            <table class="table_form al" border="0">
                ...
                <tr>
                    <th><label for="textarea2">Comment <span class="required">*</span></label></th>
                    <td>
                        <textarea class="textarea_2" id="text_comments" maxlength="100" placeholder="No existing comment."></textarea>
                        <p class="ar mr5">Characters: <span name="char_num">100</span></p>
                    </td>
                    <td><input type="hidden" name="updateform_month_name" value=""></td>
                </tr>
            </table>
            <div class="btn_div">
                <a href="javascript:void(0);" class="btn btn_type_3 btn_space" id="save_update_form"><span>Save</span></a>
