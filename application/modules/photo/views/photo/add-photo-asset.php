<h2 class="title nm np fl"><strong class="">Add New Photo Asset </strong>
   <span class="subtext fn"><!-- nothing here --></span>
</h2>
         ...
         <tr>
            ...
            <td>
               <select class="select_type_3 nm np" id="select1" name="category">
                  ...
                  <option value="<?php echo $rows->tpac_idx;?>"><?php echo $rows->tpac_category;?></option>
                  <?php }?>
                  <?php }?>
               </select>
            </td>
         ...
         <tr>
            ...
            <td>
               <div class="fl nm np" style="display:inline-block">
                  <input type="text" name="item" class="input_type_2 nm" />
               </div>
            </td>
         </tr>
         <tr>
            ...
            <td>
               <div class="fl nm np" style="display:inline-block">
                  <textarea class="tarea" name="description" rows="5" cols="57"></textarea>
               </div>
            </td>
         </tr>
         <tr>
            ...
            <td>
               <div class="fl nm np" style="display:inline-block">
                  <textarea class="tarea" name="remarks" rows="5" cols="57"></textarea>
               </div>
            </td>
         </tr>         
         <tr>
            ...
            <td>
               <select class="select_type_3 nm np" name="status">
                  ...
                  <option value="<?php echo $rows->tpas_idx;?>"><?php echo $rows->tpas_status;?></option>
                  <?php }?>
                  <?php }?>
               </select>
            </td>
